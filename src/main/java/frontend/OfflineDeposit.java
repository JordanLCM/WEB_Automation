...
public class OfflineDeposit {
	...
	static String reportName = "Offline Deposit";
	...
	@Test(dependsOnMethods = { "verify_Login" }, priority = 5)
	public void click_Deposit_Option() throws FailedLoginException, InterruptedException {
		createR.do_Create_Test("click_Deposit_Option".toUpperCase());
		func.go_To_Deposit_Option();
		bd.getDriver().get(siteUrl);
		func.go_To_Deposit_Option_Via_Floating_Icon();
	}
